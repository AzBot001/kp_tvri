...
<div class="content-wrapper">
    <section class="content">
        <div class="container-fluid">
            ...
            <a href="<?= $base_url ?>dataBeritaNaskah_eic" class="btn btn-danger mt-3 mb-3"><i class="fas fa-arrow-left"></i></a>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-5">
                                    <button type="submit" name="verifikasighi" class="btn btn-block btn-success">Simpan</button>
                                </div>
                            </div>
                            <!-- /.card-body -->
                        </div>
