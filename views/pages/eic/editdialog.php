...
<div class="content-wrapper">
    <section class="content">
        ...
        <a href="<?= $base_url ?>dataBeritaNaskah_eic" class="btn btn-danger mb-3 mt-3"><i class="fas fa-arrow-left"></i></a>
                    ...
                    <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="judul" type="text" value="<?= $d['judul'] ?>" class="form-control" placeholder="Masukkan Judul Berita">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <!-- text input -->
                                        <div class="form-group">
                                            ...
                                            <input name="narasumber" value="<?= $d['narasumber'] ?>" type="text" class="form-control" placeholder="Masukkan Nama Narasumber">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-5">
                                    <button type="submit" name="verifikasidialog" class="btn btn-block btn-success">Simpan</button>
                                </div>
                            </div>
                            <!-- /.card-body -->
                        </div>
