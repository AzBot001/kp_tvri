        ...
        <tr>
            ...
            <td>
                <form action="" method="post">
                    ...
                    <a href="<?= $base_url ?>app/controller/admin/cetak/cetak_ghi.php?id=<?= $data['id_naskah'] ?>" class="btn btn-success btn-xs" target="_blank"><i class="fas fa-print"></i></a>
                </form>
            </td>
        </tr>
    <?php
    ...
    ?>
        <tr>
            ...
            <td>
                <form action="" method="post">
                    <input type="hidden" name="id" value="<?= $data['id_naskah'] ?>">
                    <a href="<?= $base_url ?>app/controller/admin/cetak/cetak_gns.php?id=<?= $data['id_naskah'] ?>" class="btn btn-success btn-xs" target="_blank"><i class="fas fa-print"></i></a>
                </form>
            </td>
        </tr>
    <?php
    ...
    ?>
        <tr>
            ...
            <td>
                <form action="" method="post">
                    <input type="hidden" name="id" value="<?= $data['id_naskah'] ?>">
                    <a href="<?= $base_url ?>app/controller/admin/cetak/cetak_habari.php?id=<?= $data['id_naskah'] ?>" class="btn btn-success btn-xs" target="_blank"><i class="fas fa-print"></i></a>
                </form>
            </td>
        </tr>
    <?php
    ...
    ?>
        <tr>
            ...
            <td>
                <form action="" method="post">
                    <input type="hidden" name="id" value="<?= $data['id_naskah'] ?>">
                    <a href="<?= $base_url ?>app/controller/admin/cetak/cetak_sulampa.php?id=<?= $data['id_naskah'] ?>" class="btn btn-success btn-xs" target="_blank"><i class="fas fa-print"></i></a>
                </form>
            </td>
        </tr>
    <?php
    ...
    ?>
        <tr>
            ...
            <td>
                <form action="" method="post">
                    <input type="hidden" name="id" value="<?= $data['id_naskah'] ?>">
                    <a href="<?= $base_url ?>app/controller/admin/cetak/cetak_dialog.php?id=<?= $data['id_naskah'] ?>" class="btn btn-success btn-xs" target="_blank"><i class="fas fa-print"></i></a>
                </form>
            </td>
        </tr>
<?php
