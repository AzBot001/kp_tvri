...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 30, 2022 at 12:38 AM
...
(32, 11, '1', 'ALIKUSU - PENGOLAH  NASI KUNING', 'ABID HARUN TVRI GORONTALO'),
(33, 2, '1', 'biasa', 'Untuk memastikan potensi penambahan kursi tersebut terwujud/ maka pihak kpu kota gorontalo berencana akan menggelar rapat kerja  bersama dengan dprd kota terkait mekanisme penambahan sesuai regulasi yang ada//  Namun/ Meksi ada perubahan jumlah penduduk/ pihaknya memastikan tidak akan berdampak pada perubahan jumlah daerah pemilihan (dapil)/ yakni 4 dapil di kota gorontalo// \r\n\r\n\r\n\r\nTeti Novianti/ Wahyu Thalib/ TVRI Gorontalo//'),
(34, 3, '2', ' Fatimah asri mutmainnah - Komisioner komisi nasional disabilitas republik indonesia', 'Tak hanya itu/ Untuk memastikan Implementasi peraturan daerah (perda) dapat konfrehensif dan akomodatif bagi penyandang disabilitas/ pihaknya akan melakukan kolaborasi dengan berbagai pihak/  baik dari knd/ maupun pemerintah daerah/ terkait percepatan penanganan terhadap pemenuhan hak penyandang disabilitas// \r\n\r\n\r\nTeti Novianti/ Ipong Stive/ TVRI Gorontalo'),
(35, 3, '1', ' Doktor insinyur haji yosef p. Koton - staf ahli gubernur bidang kemasyarakatan dan sdm provinsi gorontalo', 'Sementara itu/ Komisioner komisi nasional disabilitas republik indonesia/ Fatimah asri mutmainnah/ mengungkap provinsi gorontalo  merupakan wilayah pertama di sulawesi yang \r\nmemiliki indeks pembangunan manusia yang masih rendah//\r\n\r\nOlehnya hal tersebut menjadi perhatian dan evaluasi bagi komisi nasional disabilitas/ bagaimana pihaknya mengikuti pengarusutamaan disabilitas yang sedang massif digencarkan oleh pemerintah/sehinga pemenuhan hak disabilitas bisa tercapai// ');
...
(11, 'MAKAN NASI KUNING DENGAN MERAH', 'KOTA GORONTALO', '1', '2022-07-23', '5', 1, 'INI LEAD DARI JUDUL MKAAN NASI KUNING INI LEAD DARI JUDUL MKAAN NASI KUNING INI LEAD DARI JUDUL MKAAN NASI KUNING INI LEAD DARI JUDUL MKAAN NASI KUNING INI LEAD DARI JUDUL MKAAN NASI KUNING INI LEAD DARI JUDUL MKAAN NASI KUNING INI LEAD DARI JUDUL MKAAN NASI KUNING INI LEAD DARI JUDUL MKAAN NASI KUNING INI LEAD DARI JUDUL MKAAN NASI KUNING MERAH', 'IINI NARASI DARI JUDUL MAKAN NASI KUNING INI LEAD DARI JUDUL MKAAN NASI KUNING INI LEAD DARI JUDUL MKAAN NASI KUNING INI LEAD DARI JUDUL MKAAN NASI KUNING INI LEAD DARI JUDUL MKAAN NASI KUNING INI LEAD DARI JUDUL MKAAN NASI KUNING MERAHH', 'ghi', 1, 1, 1, '', '', '', '00:02:23');
...
--
ALTER TABLE `naskah`
  MODIFY `id_naskah` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
