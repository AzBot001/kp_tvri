                    ...
                    <div class="col-md-12">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label>Rep / Cam</label>
                                            <input name="kameramen" value="<?= $d['kameramen'] ?>" type="text" class="form-control" placeholder="Masukkan Reporter dan Kameramen Berita" required>
                                        </div>
                                    </div>
                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-5">
                                    <button type="submit" name="verifikasisulampa" class="btn btn-block btn-success">Simpan</button>
                                </div>
                            </div>
                            <!-- /.card-body -->
                        </div>
